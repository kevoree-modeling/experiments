                ...
                (function (profiling) {
                    var GaussianMixtureNode = (function (_super) {
                        ...
                        GaussianMixtureNode.prototype.setProperty = function (propertyName, propertyType, propertyValue) {
                            if (propertyName === org.mwg.ml.algorithm.profiling.GaussianMixtureNode.LEVEL) {
                                _super.prototype.setPropertyWithType.call(this, propertyName, propertyType, propertyValue, org.mwg.Type.INT);
                            }
                            else {
                                if (propertyName === org.mwg.ml.algorithm.profiling.GaussianMixtureNode.WIDTH) {
                                    _super.prototype.setPropertyWithType.call(this, propertyName, propertyType, propertyValue, org.mwg.Type.INT);
                                }
                                else {
                                    if (propertyName === org.mwg.ml.algorithm.profiling.GaussianMixtureNode.COMPRESSION_FACTOR) {
                                        _super.prototype.setPropertyWithType.call(this, propertyName, propertyType, propertyValue, org.mwg.Type.DOUBLE);
                                    }
                                    else {
                                        if (propertyName === org.mwg.ml.algorithm.profiling.GaussianMixtureNode.THRESHOLD) {
                                            _super.prototype.setPropertyWithType.call(this, propertyName, propertyType, propertyValue, org.mwg.Type.DOUBLE);
                                        }
                                        else {
                                            if (propertyName === org.mwg.ml.algorithm.profiling.GaussianMixtureNode.PRECISION) {
                        ...
                        GaussianMixtureNode.prototype.type = function (attributeName) {
                            if (attributeName === org.mwg.ml.algorithm.profiling.GaussianMixtureNode.AVG) {
                                return org.mwg.Type.DOUBLE_ARRAY;
                            }
                            else {
                                if (attributeName === org.mwg.ml.algorithm.profiling.GaussianMixtureNode.MIN) {
                                    return org.mwg.Type.DOUBLE_ARRAY;
                                }
                                else {
                                    if (attributeName === org.mwg.ml.algorithm.profiling.GaussianMixtureNode.MAX) {
                                        return org.mwg.Type.DOUBLE_ARRAY;
                                    }
                                    else {
                                        if (attributeName === org.mwg.ml.algorithm.profiling.GaussianMixtureNode.COV) {
                                            return org.mwg.Type.DOUBLE_ARRAY;
                                        }
                                        else {
                                            if (attributeName === org.mwg.ml.algorithm.profiling.GaussianMixtureNode.PRECISION) {
                                                return org.mwg.Type.DOUBLE_ARRAY;
                                            }
                                            else {
                                    ...
                                    if (attributeName === org.mwg.ml.algorithm.profiling.GaussianMixtureNode.MAX) {
                                        ...
                                        if (attributeName === org.mwg.ml.algorithm.profiling.GaussianMixtureNode.MAX) {
                                            ...
                                            if (attributeName === org.mwg.ml.algorithm.profiling.GaussianMixtureNode.COV) {
                                                ...
                                                var initialPrecision = resolved.getFromKey(org.mwg.ml.algorithm.profiling.GaussianMixtureNode.PRECISION);
                        ...
                        GaussianMixtureNode.prototype.learnVector = function (values, callback) {
                            var _this = this;
                            var resolved = this._resolver.resolveState(this, true);
                            var width = resolved.getFromKeyWithDefault(org.mwg.ml.algorithm.profiling.GaussianMixtureNode.WIDTH, org.mwg.ml.algorithm.profiling.GaussianMixtureNode.WIDTH_DEF);
                            var compressionFactor = resolved.getFromKeyWithDefault(org.mwg.ml.algorithm.profiling.GaussianMixtureNode.COMPRESSION_FACTOR, org.mwg.ml.algorithm.profiling.GaussianMixtureNode.COMPRESSION_FACTOR_DEF);
                            var compressionIter = resolved.getFromKeyWithDefault(org.mwg.ml.algorithm.profiling.GaussianMixtureNode.COMPRESSION_ITER, org.mwg.ml.algorithm.profiling.GaussianMixtureNode.COMPRESSION_ITER_DEF);
                            var initialPrecision = resolved.getFromKey(org.mwg.ml.algorithm.profiling.GaussianMixtureNode.PRECISION);
                            if (initialPrecision == null) {
                            ...
                            var threshold = resolved.getFromKeyWithDefault(org.mwg.ml.algorithm.profiling.GaussianMixtureNode.THRESHOLD, org.mwg.ml.algorithm.profiling.GaussianMixtureNode.THRESHOLD_DEF);
                            ...
                            traverse.fromVar("starterNode").traverse(org.mwg.ml.algorithm.profiling.GaussianMixtureNode.INTERNAL_SUBGAUSSIAN).then(function (context) {
                        ...
                        GaussianMixtureNode.prototype.getLevel = function () {
                            return this._resolver.resolveState(this, true).getFromKeyWithDefault(org.mwg.ml.algorithm.profiling.GaussianMixtureNode.LEVEL, org.mwg.ml.algorithm.profiling.GaussianMixtureNode.LEVEL_DEF);
                        };
                        GaussianMixtureNode.prototype.getWidth = function () {
                            return this._resolver.resolveState(this, true).getFromKeyWithDefault(org.mwg.ml.algorithm.profiling.GaussianMixtureNode.WIDTH, org.mwg.ml.algorithm.profiling.GaussianMixtureNode.WIDTH_DEF);
                        };
                        GaussianMixtureNode.prototype.getCompressionFactor = function () {
                            return this._resolver.resolveState(this, true).getFromKeyWithDefault(org.mwg.ml.algorithm.profiling.GaussianMixtureNode.COMPRESSION_FACTOR, org.mwg.ml.algorithm.profiling.GaussianMixtureNode.COMPRESSION_FACTOR_DEF);
                        };
                        GaussianMixtureNode.prototype.getCompressionIter = function () {
                            return this._resolver.resolveState(this, true).getFromKeyWithDefault(org.mwg.ml.algorithm.profiling.GaussianMixtureNode.COMPRESSION_ITER, org.mwg.ml.algorithm.profiling.GaussianMixtureNode.COMPRESSION_ITER_DEF);
                        };
                        GaussianMixtureNode.prototype.updateLevel = function (newLevel) {
                            _super.prototype.set.call(this, org.mwg.ml.algorithm.profiling.GaussianMixtureNode.LEVEL, newLevel);
                            if (newLevel == 0) {
                                _super.prototype.set.call(this, org.mwg.ml.algorithm.profiling.GaussianMixtureNode.INTERNAL_SUBGAUSSIAN, new Float64Array(0));
                            }
                            else {
                                _super.prototype.rel.call(this, org.mwg.ml.algorithm.profiling.GaussianMixtureNode.INTERNAL_SUBGAUSSIAN, function (result) {
                                    for (var i = 0; i < result.length; i++) {
                                        var g = result[i];
                        ...
                        GaussianMixtureNode.prototype.createLevel = function (values, level, width, compressionFactor, compressionIter, precisions, threshold) {
                            var g = this.graph().newTypedNode(this.world(), this.time(), org.mwg.ml.algorithm.profiling.GaussianMixtureNode.NAME);
                            g.set(org.mwg.ml.algorithm.profiling.GaussianMixtureNode.LEVEL, level);
                            g.internallearn(values, width, compressionFactor, compressionIter, precisions, threshold, false);
                            _super.prototype.add.call(this, org.mwg.ml.algorithm.profiling.GaussianMixtureNode.INTERNAL_SUBGAUSSIAN, g);
                            return g;
                        };
                        GaussianMixtureNode.prototype.checkAndCompress = function (width, compressionFactor, compressionIter, precisions, threshold) {
                            var selfPointer = this;
                            var subgaussians = _super.prototype.get.call(this, org.mwg.ml.algorithm.profiling.GaussianMixtureNode.INTERNAL_SUBGAUSSIAN);
                        ...
                        GaussianMixtureNode.prototype.move = function (subgaus) {
                            ...
                            this.set(org.mwg.ml.algorithm.profiling.GaussianMixtureNode.INTERNAL_TOTAL_KEY, total);
                            this.set(org.mwg.ml.algorithm.profiling.GaussianMixtureNode.INTERNAL_SUM_KEY, sum);
                            this.set(org.mwg.ml.algorithm.profiling.GaussianMixtureNode.INTERNAL_MIN_KEY, min);
                            this.set(org.mwg.ml.algorithm.profiling.GaussianMixtureNode.INTERNAL_MAX_KEY, max);
                            this.set(org.mwg.ml.algorithm.profiling.GaussianMixtureNode.INTERNAL_SUMSQUARE_KEY, sumsquares);
                            if (level > 0) {
                                var subrelations = subgaus.get(org.mwg.ml.algorithm.profiling.GaussianMixtureNode.INTERNAL_SUBGAUSSIAN);
                                if (subrelations == null) {
                                    subgaus.updateLevel(level - 1);
                                    _super.prototype.add.call(this, org.mwg.ml.algorithm.profiling.GaussianMixtureNode.INTERNAL_SUBGAUSSIAN, subgaus);
                                }
                                else {
                                    var oldrel = this.get(org.mwg.ml.algorithm.profiling.GaussianMixtureNode.INTERNAL_SUBGAUSSIAN);
                                    if (oldrel == null) {
                                    ...
                                    this.set(org.mwg.ml.algorithm.profiling.GaussianMixtureNode.INTERNAL_SUBGAUSSIAN, newrelations);
                                }
                            }
                        };
                        GaussianMixtureNode.prototype.query = function (level, min, max, callback) {
                            ...
                            for (var i = 0; i < this.getLevel() - level; i++) {
                                deepTraverseTask.traverseOrKeep(org.mwg.ml.algorithm.profiling.GaussianMixtureNode.INTERNAL_SUBGAUSSIAN);
                                var finalI = i;
                        ...
                        GaussianMixtureNode.prototype.internallearn = function (values, width, compressionFactor, compressionIter, precisions, threshold, createNode) {
                            ...
                            if (total == 0) {
                                ...
                                var sumsquares;
                                if (total == 1) {
                                    sum = _super.prototype.get.call(this, org.mwg.ml.algorithm.profiling.GaussianMixtureNode.INTERNAL_SUM_KEY);
                                    ...
                                    sum = _super.prototype.get.call(this, org.mwg.ml.algorithm.profiling.GaussianMixtureNode.INTERNAL_SUM_KEY);
                                    min = _super.prototype.get.call(this, org.mwg.ml.algorithm.profiling.GaussianMixtureNode.INTERNAL_MIN_KEY);
                                    max = _super.prototype.get.call(this, org.mwg.ml.algorithm.profiling.GaussianMixtureNode.INTERNAL_MAX_KEY);
                                    sumsquares = _super.prototype.get.call(this, org.mwg.ml.algorithm.profiling.GaussianMixtureNode.INTERNAL_SUMSQUARE_KEY);
                                }
                                for (var i = 0; i < features; i++) {
                                    if (values[i] < min[i]) {
                                        min[i] = values[i];
                        ...
                        GaussianMixtureNode.prototype.getNumberOfFeatures = function () {
                            ...
                            if (total == 0) {
                                ...
                                var sum = _super.prototype.get.call(this, org.mwg.ml.algorithm.profiling.GaussianMixtureNode.INTERNAL_SUM_KEY);
                                return sum.length;
                            }
                        };
                        GaussianMixtureNode.prototype.getSum = function () {
                            ...
                            if (total == 0) {
                                ...
                                return _super.prototype.get.call(this, org.mwg.ml.algorithm.profiling.GaussianMixtureNode.INTERNAL_SUM_KEY);
                            }
                        };
                        GaussianMixtureNode.prototype.getSumSquares = function () {
                            ...
                            if (total == 1) {
                                ...
                                return _super.prototype.get.call(this, org.mwg.ml.algorithm.profiling.GaussianMixtureNode.INTERNAL_SUMSQUARE_KEY);
                            }
                        };
                        GaussianMixtureNode.prototype.getProbability = function (featArray, err, normalizeOnAvg) {
                            var sum = _super.prototype.get.call(this, org.mwg.ml.algorithm.profiling.GaussianMixtureNode.INTERNAL_SUM_KEY);
                            var sumsquares = _super.prototype.get.call(this, org.mwg.ml.algorithm.profiling.GaussianMixtureNode.INTERNAL_SUMSQUARE_KEY);
                        ...
                        GaussianMixtureNode.prototype.getTotal = function () {
                            var x = _super.prototype.get.call(this, org.mwg.ml.algorithm.profiling.GaussianMixtureNode.INTERNAL_TOTAL_KEY);
                            if (x == null) {
                                return 0;
                            }
                            else {
                        ...
                        GaussianMixtureNode.prototype.getAvg = function () {
                            ...
                            if (total == 1) {
                                ...
                                var avg = _super.prototype.get.call(this, org.mwg.ml.algorithm.profiling.GaussianMixtureNode.INTERNAL_SUM_KEY);
                        ...
                        GaussianMixtureNode.prototype.getMin = function () {
                            ...
                            if (total == 1) {
                                var min = _super.prototype.get.call(this, org.mwg.ml.algorithm.profiling.GaussianMixtureNode.INTERNAL_SUM_KEY);
                                return min;
                            }
                            else {
                                var min = _super.prototype.get.call(this, org.mwg.ml.algorithm.profiling.GaussianMixtureNode.INTERNAL_MIN_KEY);
                                return min;
                            }
                        };
                        GaussianMixtureNode.prototype.getMax = function () {
                            ...
                            if (total == 1) {
                                var max = _super.prototype.get.call(this, org.mwg.ml.algorithm.profiling.GaussianMixtureNode.INTERNAL_SUM_KEY);
                                return max;
                            }
                            else {
                                var max = _super.prototype.get.call(this, org.mwg.ml.algorithm.profiling.GaussianMixtureNode.INTERNAL_MAX_KEY);
                                return max;
                            }
                        };
                        GaussianMixtureNode.prototype.getSubGraph = function () {
                            var res = _super.prototype.get.call(this, org.mwg.ml.algorithm.profiling.GaussianMixtureNode.INTERNAL_SUBGAUSSIAN);
                            if (res == null) {
                    ...
                    var GaussianMixtureNode;
                    (function (GaussianMixtureNode) {
                        var Factory = (function () {
                            function Factory() {
                            }
                            Factory.prototype.name = function () {
                                return org.mwg.ml.algorithm.profiling.GaussianMixtureNode.NAME;
                            };
                        ...
                        GaussianMixtureNode.Factory = Factory;
                    })(GaussianMixtureNode = profiling.GaussianMixtureNode || (profiling.GaussianMixtureNode = {}));
                    var GaussianSlotNode = (function (_super) {
                        ...
                        GaussianSlotNode.prototype.learnArray = function (values) {
                            ...
                            if (numOfSlot == 1 || numOfSlot == 0) {
                                ...
                                var periodSize = resolved.getFromKeyWithDefault(org.mwg.ml.algorithm.profiling.GaussianSlotNode.PERIOD_SIZE, org.mwg.ml.algorithm.profiling.GaussianSlotNode.PERIOD_SIZE_DEF);
                        ...
                        GaussianSlotNode.prototype.predict = function (callback) {
                            ...
                            var features = resolved.getFromKeyWithDefault(org.mwg.ml.algorithm.profiling.GaussianSlotNode.INTERNAL_FEATURES_NUMBER, 0);
                            if (features == 0) {
                                callback(null);
                                return;
                            }
                            ...
                            var slot = org.mwg.ml.algorithm.profiling.GaussianSlotNode.getIntTime(this.time(), numOfSlot, periodSize);
                            var index = slot * features;
                            var total = resolved.getFromKey(org.mwg.ml.algorithm.profiling.GaussianSlotNode.INTERNAL_TOTAL_KEY);
                            var sum = resolved.getFromKey(org.mwg.ml.algorithm.profiling.GaussianSlotNode.INTERNAL_SUM_KEY);
                            var min = resolved.getFromKey(org.mwg.ml.algorithm.profiling.GaussianSlotNode.INTERNAL_MIN_KEY);
                            var max = resolved.getFromKey(org.mwg.ml.algorithm.profiling.GaussianSlotNode.INTERNAL_MAX_KEY);
                            var random = new java.util.Random();
                            var result = new Float64Array(features);
                            if (total != null) {
                                if (total[slot] != 0) {
                                    for (var j = 0; j < features; j++) {
                                        result[j] = sum[j + index] / total[slot] + (0.5 * random.nextDouble() - 0.25) * (max[j + index] - min[j + index]);
                                    }
                                }
                            }
                            callback(result);
                        ...
                        GaussianSlotNode.prototype.setProperty = function (propertyName, propertyType, propertyValue) {
                            if (propertyName === org.mwg.ml.algorithm.profiling.GaussianSlotNode.SLOTS_NUMBER) {
                                _super.prototype.setPropertyWithType.call(this, propertyName, propertyType, propertyValue, org.mwg.Type.INT);
                            }
                            else {
                                if (propertyName === org.mwg.ml.algorithm.profiling.GaussianSlotNode.PERIOD_SIZE) {
                        ...
                        GaussianSlotNode.prototype.get = function (attributeName) {
                            ...
                            if (attributeName === org.mwg.ml.algorithm.profiling.GaussianSlotNode.SLOTS_NUMBER) {
                                return state.getFromKeyWithDefault(org.mwg.ml.algorithm.profiling.GaussianSlotNode.SLOTS_NUMBER, org.mwg.ml.algorithm.profiling.GaussianSlotNode.SLOTS_NUMBER_DEF);
                            }
                            else {
                                if (attributeName === org.mwg.ml.algorithm.profiling.GaussianSlotNode.PERIOD_SIZE) {
                                    return state.getFromKeyWithDefault(org.mwg.ml.algorithm.profiling.GaussianSlotNode.PERIOD_SIZE, org.mwg.ml.algorithm.profiling.GaussianSlotNode.PERIOD_SIZE_DEF);
                                }
                                else {
                                    return _super.prototype.get.call(this, attributeName);
                                }
                        ...
                        GaussianSlotNode.prototype.getMin = function () {
                            return this.unphasedState().getFromKey(org.mwg.ml.algorithm.profiling.GaussianSlotNode.INTERNAL_MIN_KEY);
                        };
                        GaussianSlotNode.prototype.getMax = function () {
                            return this.unphasedState().getFromKey(org.mwg.ml.algorithm.profiling.GaussianSlotNode.INTERNAL_MAX_KEY);
                        };
                        GaussianSlotNode.prototype.getSum = function () {
                            return this.unphasedState().getFromKey(org.mwg.ml.algorithm.profiling.GaussianSlotNode.INTERNAL_SUM_KEY);
                        };
                        GaussianSlotNode.prototype.getSumSquare = function () {
                            return this.unphasedState().getFromKey(org.mwg.ml.algorithm.profiling.GaussianSlotNode.INTERNAL_SUMSQUARE_KEY);
                        };
                        GaussianSlotNode.prototype.getTotal = function () {
                            return this.unphasedState().getFromKey(org.mwg.ml.algorithm.profiling.GaussianSlotNode.INTERNAL_TOTAL_KEY);
                        };
                    ...
                    var GaussianSlotNode;
                    (function (GaussianSlotNode) {
                        var Factory = (function () {
                            function Factory() {
                            }
                            Factory.prototype.name = function () {
                                return org.mwg.ml.algorithm.profiling.GaussianSlotNode.NAME;
                            };
                            Factory.prototype.create = function (world, time, id, graph, initialResolution) {
                        ...
                        GaussianSlotNode.Factory = Factory;
                    })(GaussianSlotNode = profiling.GaussianSlotNode || (profiling.GaussianSlotNode = {}));
                    var KMeans = (function () {
                        function KMeans() {
                        }
                ...
                (function (regression) {
                    var LiveLinearRegressionNode = (function (_super) {
                        ...
                        LiveLinearRegressionNode.prototype.internalLearn = function (input, output, callback) {
                            var state = this._resolver.resolveState(this, true);
                            var iterations = state.getFromKeyWithDefault(org.mwg.ml.algorithm.regression.LiveLinearRegressionNode.ITERATION_KEY, org.mwg.ml.algorithm.regression.LiveLinearRegressionNode.ITERATION_DEF);
                            var alpha = state.getFromKeyWithDefault(org.mwg.ml.algorithm.regression.LiveLinearRegressionNode.ALPHA_KEY, org.mwg.ml.algorithm.regression.LiveLinearRegressionNode.ALPHA_DEF);
                            var lambda = state.getFromKeyWithDefault(org.mwg.ml.algorithm.regression.LiveLinearRegressionNode.LAMBDA_KEY, org.mwg.ml.algorithm.regression.LiveLinearRegressionNode.LAMBDA_DEF);
                            var weights = state.getFromKey(org.mwg.ml.algorithm.regression.LiveLinearRegressionNode.WEIGHT_KEY);
                            if (weights == null) {
                            ...
                            var prevErr = state.getFromKeyWithDefault(org.mwg.ml.algorithm.regression.LiveLinearRegressionNode.LAST_ERR_KEY, 0.0);
                            var currErr = this.calculate(weights, input) - output;
                            if (currErr > prevErr) {
                            }
                            state.setFromKey(org.mwg.ml.algorithm.regression.LiveLinearRegressionNode.LAST_ERR_KEY, org.mwg.Type.DOUBLE, currErr);
                            ...
                            var bckupWeight = state.getFromKey(org.mwg.ml.algorithm.regression.LiveLinearRegressionNode.INTERNAL_WEIGHT_BACKUP_KEY);
                            if (bckupWeight == null) {
                                state.setFromKey(org.mwg.ml.algorithm.regression.LiveLinearRegressionNode.WEIGHT_KEY, org.mwg.Type.DOUBLE_ARRAY, weights);
                                state.setFromKey(org.mwg.ml.algorithm.regression.LiveLinearRegressionNode.INTERNAL_WEIGHT_BACKUP_KEY, org.mwg.Type.DOUBLE_ARRAY, weights);
                                state.setFromKey(org.mwg.ml.algorithm.regression.LiveLinearRegressionNode.INTERNAL_TOTAL_KEY, org.mwg.Type.INT, 1);
                            }
                            else {
                                var diff = 0;
                                for (var i = 0; i < weights.length; i++) {
                                ...
                                var deviation = state.getFromKeyWithDefault(org.mwg.ml.algorithm.regression.LiveLinearRegressionNode.THRESHOLD_KEY, org.mwg.ml.algorithm.regression.LiveLinearRegressionNode.THRESHOLD_DEF);
                                if (diff > deviation) {
                                    ...
                                    state.setFromKey(org.mwg.ml.algorithm.regression.LiveLinearRegressionNode.WEIGHT_KEY, org.mwg.Type.DOUBLE_ARRAY, weights);
                                    state.setFromKey(org.mwg.ml.algorithm.regression.LiveLinearRegressionNode.INTERNAL_TOTAL_KEY, org.mwg.Type.INT, state.getFromKey(org.mwg.ml.algorithm.regression.LiveLinearRegressionNode.INTERNAL_TOTAL_KEY) + 1);
                                }
                            }
                            if (callback != null) {
                                callback(true);
                        ...
                        LiveLinearRegressionNode.prototype.setProperty = function (propertyName, propertyType, propertyValue) {
                            if (propertyName === org.mwg.ml.algorithm.regression.LiveLinearRegressionNode.ALPHA_KEY) {
                                _super.prototype.setPropertyWithType.call(this, propertyName, propertyType, propertyValue, org.mwg.Type.DOUBLE);
                            }
                            else {
                                if (propertyName === org.mwg.ml.algorithm.regression.LiveLinearRegressionNode.LAMBDA_KEY) {
                                    _super.prototype.setPropertyWithType.call(this, propertyName, propertyType, propertyValue, org.mwg.Type.DOUBLE);
                                }
                                else {
                                    if (propertyName === org.mwg.ml.algorithm.regression.LiveLinearRegressionNode.ITERATION_KEY) {
                                        _super.prototype.setPropertyWithType.call(this, propertyName, propertyType, propertyValue, org.mwg.Type.INT);
                                    }
                                    else {
                                        _super.prototype.setProperty.call(this, propertyName, propertyType, propertyValue);
                    ...
                    var LiveLinearRegressionNode;
                    (function (LiveLinearRegressionNode) {
                        var Factory = (function () {
                            function Factory() {
                            }
                            Factory.prototype.name = function () {
                                return org.mwg.ml.algorithm.regression.LiveLinearRegressionNode.NAME;
                            };
                            Factory.prototype.create = function (world, time, id, graph, initialResolution) {
                        ...
                        LiveLinearRegressionNode.Factory = Factory;
                    })(LiveLinearRegressionNode = regression.LiveLinearRegressionNode || (regression.LiveLinearRegressionNode = {}));
                    var PolynomialNode = (function (_super) {
                        ...
                        PolynomialNode.prototype.setProperty = function (propertyName, propertyType, propertyValue) {
                            if (propertyName === org.mwg.ml.algorithm.regression.PolynomialNode.VALUE) {
                                this.learn(parseFloat(propertyValue.toString()), null);
                            }
                            else {
                                if (propertyName === org.mwg.ml.algorithm.regression.PolynomialNode.PRECISION) {
                                    _super.prototype.setPropertyWithType.call(this, propertyName, propertyType, propertyValue, org.mwg.Type.DOUBLE);
                                }
                                else {
                                    throw new Error(org.mwg.ml.algorithm.regression.PolynomialNode.NOT_MANAGED_ATT_ERROR);
                                }
                            }
                        };
                        ...
                        PolynomialNode.prototype.learn = function (value, callback) {
                            ...
                            var precision = previousState.getFromKeyWithDefault(org.mwg.ml.algorithm.regression.PolynomialNode.PRECISION, org.mwg.ml.algorithm.regression.PolynomialNode.PRECISION_DEF);
                            ...
                            var newMaxDegree = Math.min(num, org.mwg.ml.algorithm.regression.PolynomialNode.MAX_DEGREE);
                            if (deg < newMaxDegree) {
                                deg++;
                            ...
                            if (nodeTime > previousTime) {
                                ...
                                phasedState.setFromKey(org.mwg.ml.algorithm.regression.PolynomialNode.PRECISION, org.mwg.Type.DOUBLE, precision);
                        ...
                        PolynomialNode.prototype.extrapolate = function (callback) {
                            ...
                            var lastTime = state.getFromKey(org.mwg.ml.algorithm.regression.PolynomialNode.INTERNAL_LAST_TIME_KEY);
                            if (t > lastTime) {
                                t = lastTime;
                            }
                            t = t / inferSTEP;
                ...
                (function (matrix) {
                    ...
                    var HybridMatrixEngine = (function () {
                        ...
                        HybridMatrixEngine.prototype.multiplyTransposeAlphaBeta = function (transA, alpha, matA, transB, matB, beta, matC) {
                            if (matA.leadingDimension() < org.mwg.ml.common.matrix.HybridMatrixEngine.MULT_LIMIT && matB.leadingDimension() < org.mwg.ml.common.matrix.HybridMatrixEngine.MULT_LIMIT) {
                        ...
                        HybridMatrixEngine.prototype.invert = function (mat, invertInPlace) {
                            if (mat.rows() < org.mwg.ml.common.matrix.HybridMatrixEngine.INVERT_LIMIT) {
                        ...
                        HybridMatrixEngine.prototype.pinv = function (mat, invertInPlace) {
                            if (mat.rows() < org.mwg.ml.common.matrix.HybridMatrixEngine.PINV_LIMIT) {
                        ...
                        HybridMatrixEngine.prototype.solveLU = function (matA, matB, workInPlace, transB) {
                            if (matA.leadingDimension() < org.mwg.ml.common.matrix.HybridMatrixEngine.SOLVELU_LIMIT && matB.leadingDimension() < org.mwg.ml.common.matrix.HybridMatrixEngine.SOLVELU_LIMIT) {
                        ...
                        HybridMatrixEngine.prototype.solveQR = function (matA, matB, workInPlace, transB) {
                            if (matA.leadingDimension() < org.mwg.ml.common.matrix.HybridMatrixEngine.SOLVEQR_LIMIT && matB.leadingDimension() < org.mwg.ml.common.matrix.HybridMatrixEngine.SOLVEQR_LIMIT) {
                        ...
                        HybridMatrixEngine.prototype.decomposeSVD = function (matA, workInPlace) {
                            if (matA.leadingDimension() < org.mwg.ml.common.matrix.HybridMatrixEngine.SOLVESVD_LIMIT) {
