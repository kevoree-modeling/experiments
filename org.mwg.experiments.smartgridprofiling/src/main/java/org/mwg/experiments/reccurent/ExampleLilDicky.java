...
import org.mwg.experiments.reccurent.datasets.TextGenerationUnbroken;
...
public class ExampleLilDicky {
	public static void main(String[] args) throws Exception {
		String loc="/Users/assaad/work/github/experiments/";
		...
		DataSet data = new TextGenerationUnbroken(loc+"datasets/text/"+textSource+".txt", totalSequences, sequenceMinLength, sequenceMaxLength, rng);
		String savePath = loc+"saved_models/"+textSource+".ser";
